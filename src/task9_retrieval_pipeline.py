...
SCORE_THRESHOLD = 0.01   # Ngưỡng điểm RRF (max rank 1 ở cả 2 list là ~0.032)
DEFAULT_TOP_K = 5
...
def retrieve(
    ...
    # Step 3: Rerank
    # RRF đã gộp và sắp xếp ở Bước 2 rồi, nếu config là "rrf" thì không cần gọi model rerank (Step 3) nữa.
